# the archives-parlementaires corpus uses an online .dtd file that meanwhile vanished.
# a copy that was retrieved via https://web.archive.org is provdided
...
adjust_references: Final = partial(
    re.compile(
        re.escape(b"http://www.tei-c.org/Lite/DTD/teixlite.dtd"), flags=re.IGNORECASE
    ).subn,
    b"./teixlite.dtd",
)
...
async def main(files: set[Path]):
    Path("teixlite.dtd").write_bytes(DTD_CONTENTS)
...
DTD_CONTENTS: Final = b"""\
<!-- TEI DTD  generated on 2004-07-16 -->

<!--
 ** Text Encoding Initiative Consortium:
 ** Guidelines for Electronic Text Encoding and Interchange.
 ** Compiled version of TEI Lite, a view of the the TEI DTD, as
 ** documented in TEI U5. Based on the 2004-07-15 TEI P4 (XML) DTD.
 **
 ** Copyright 2004 TEI Consortium.
 **
 ** This document type declaration is free "software"; you can
 ...
 ** DTD". This can often be most easily accomplished by obtaining the
 ** customization files used to make this file (available at
 ** http://www.tei-c.org/Lite/DTD/teilitex.dtd and
 ** http://www.tei-c.org/Lite/DTD/teilitex.ent), modifying those files
 ** to suit your needs, and then generating a compiled DTD like this
 ** one using the "pizza chef" at http://www.tei-c.org/pizza.html.
 **
 ** Users not following these recomendations, but rather directly
 ** modifying this file, are asked to change the root element name
 ** from "TEI.2" to something that does not start with the letters
 ** "TEI" or "tei".
 **
...
-->
<!--
 ** This file is the equivalent of the following DOCTYPE declaration:
 ...
 **    <!ENTITY % TEI.extensions.ent SYSTEM 'http://www.tei-c.org/Lite/DTD/teilitex.ent' >
 **    <!ENTITY % TEI.extensions.dtd SYSTEM 'http://www.tei-c.org/Lite/DTD/teilitex.dtd' >
 ** ]>
 ** and was actually created by maketeidtd using the driver
 ** file at http://www.tei-c.org/Lite/DTD/teixlite.dec.
 -->
...
<!ELEMENT titleStmt 
	(title+, (author | editor | sponsor | funder | principal 
	| respStmt)*) >
<!ATTLIST titleStmt 
	corresp IDREFS #IMPLIED
	next IDREF #IMPLIED
...
<!ELEMENT sponsor 
	...
	| seg | gi | anchor | gap | figure | index | interp | interpGrp 
	| lb | milestone | pb)* >
<!ATTLIST sponsor 
	corresp IDREFS #IMPLIED
	next IDREF #IMPLIED
...
<!ELEMENT publicationStmt 
	((p, (anchor | gap | figure | index | interp | interpGrp 
	| lb | milestone | pb)*)+ | ((publisher | distributor | 
...
<!ELEMENT tagUsage 
	...
	| unclear | formula | emph | foreign | gloss | hi | mentioned 
	| soCalled | term | title | ptr | ref | xptr | xref | s 
	| seg | gi | eg | bibl | biblFull | cit | q | label | list 
	| listBibl | note | stage | table | text | anchor | gap 
	| figure | index | interp | interpGrp | lb | milestone | 
	pb)* >
<!ATTLIST tagUsage 
	corresp IDREFS #IMPLIED
	next IDREF #IMPLIED
...
<!ELEMENT q 
	...
	| soCalled | term | title | ptr | ref | xptr | xref | s 
	| seg | gi | eg | bibl | biblFull | cit | q | label | list 
	| listBibl | note | stage | table | text | ab | l | lg | 
	p | sp | anchor | gap | figure | index | interp | interpGrp 
	| lb | milestone | pb)* >
<!ATTLIST q 
	corresp IDREFS #IMPLIED
	next IDREF #IMPLIED
...
<!ELEMENT cit 
	(q | bibl | biblFull | ptr | ref | xptr | xref | anchor 
	| gap | figure | index | interp | interpGrp | lb | milestone 
	| pb)+ >
<!ATTLIST cit 
	corresp IDREFS #IMPLIED
	next IDREF #IMPLIED
...
<!ELEMENT address 
	((anchor | gap | figure | index | interp | interpGrp | lb 
	| milestone | pb)*, ((addrLine, (anchor | gap | figure | 
	index | interp | interpGrp | lb | milestone | pb)*)+ | (name, 
	(anchor | gap | figure | index | interp | interpGrp | lb 
	| milestone | pb)*)*)) >
<!ATTLIST address 
	corresp IDREFS #IMPLIED
...
<!ELEMENT list 
	((anchor | gap | figure | index | interp | interpGrp | lb 
	| milestone | pb)*, (head, (anchor | gap | figure | index 
	| interp | interpGrp | lb | milestone | pb)*)?, ((item, 
	(anchor | gap | figure | index | interp | interpGrp | lb 
	| milestone | pb)*)* | (label, (anchor | gap | figure | 
	index | interp | interpGrp | lb | milestone | pb)*, item, 
	(anchor | gap | figure | index | interp | interpGrp | lb 
	| milestone | pb)*)+)) >
<!ATTLIST list 
	corresp IDREFS #IMPLIED
...
<!ELEMENT bibl 
	...
	| unclear | formula | emph | foreign | gloss | hi | mentioned 
	| soCalled | term | title | ptr | ref | xptr | xref | s 
	| seg | gi | author | biblScope | edition | editor | extent 
	| idno | imprint | note | pubPlace | publisher | respStmt 
	| anchor | gap | figure | index | interp | interpGrp | lb 
	| milestone | pb)* >
<!ATTLIST bibl 
	corresp IDREFS #IMPLIED
...
<!ELEMENT biblFull 
	((anchor | gap | figure | index | interp | interpGrp | lb 
	| milestone | pb)*, titleStmt, (anchor | gap | figure | 
	index | interp | interpGrp | lb | milestone | pb)*, (editionStmt, 
	(anchor | gap | figure | index | interp | interpGrp | lb 
	| milestone | pb)*)?, (extent, (anchor | gap | figure | 
	index | interp | interpGrp | lb | milestone | pb)*)?, publicationStmt, 
	(anchor | gap | figure | index | interp | interpGrp | lb 
	| milestone | pb)*, (seriesStmt, (anchor | gap | figure 
	| index | interp | interpGrp | lb | milestone | pb)*)?, 
	(notesStmt, (anchor | gap | figure | index | interp | interpGrp 
	| lb | milestone | pb)*)?, (sourceDesc, (anchor | gap | 
	figure | index | interp | interpGrp | lb | milestone | pb)*)*) >
<!ATTLIST biblFull 
	corresp IDREFS #IMPLIED
	next IDREF #IMPLIED
	prev IDREF #IMPLIED
...
<!ELEMENT listBibl 
	((anchor | gap | figure | index | interp | interpGrp | lb 
	| milestone | pb)*, (head, (anchor | gap | figure | index 
	| interp | interpGrp | lb | milestone | pb)*)?, (bibl | 
	biblFull), (bibl | biblFull | anchor | gap | figure | index 
	| interp | interpGrp | lb | milestone | pb)*, (trailer, 
	(anchor | gap | figure | index | interp | interpGrp | lb 
	| milestone | pb)*)?) >
<!ATTLIST listBibl 
	corresp IDREFS #IMPLIED
...
<!ELEMENT respStmt 
	(resp | name | anchor | gap | figure | index | interp | 
...
<!ELEMENT imprint 
	(pubPlace | publisher | date | biblScope | anchor | gap 
	| figure | index | interp | interpGrp | lb | milestone | 
	pb)* >
<!ATTLIST imprint 
	corresp IDREFS #IMPLIED
...
<!ELEMENT lg 
	...
	| head | opener | salute | signed | anchor | gap | figure 
	| index | interp | interpGrp | lb | milestone | pb)*, (l 
	| lg), (l | lg | anchor | gap | figure | index | interp 
	| interpGrp | lb | milestone | pb)*, ((byline | closer | 
	dateline | epigraph | salute | signed | trailer), (anchor 
	| gap | figure | index | interp | interpGrp | lb | milestone 
	| pb)*)*) >
<!ATTLIST lg 
	corresp IDREFS #IMPLIED
...
<!ELEMENT sp 
	((anchor | gap | figure | index | interp | interpGrp | lb 
	| milestone | pb)*, (speaker, (anchor | gap | figure | index 
	| interp | interpGrp | lb | milestone | pb)*)?, ((p | l 
	| lg | ab | seg | stage), (anchor | gap | figure | index 
...
<!ELEMENT body 
	((argument | byline | dateline | docAuthor | docDate | epigraph 
	| head | opener | salute | signed | anchor | gap | figure 
	| index | interp | interpGrp | lb | milestone | pb)*, ((((eg 
	| bibl | biblFull | ab | l | lg | p | sp | cit | q | label 
	| list | listBibl | note | stage | table), (anchor | gap 
	| figure | index | interp | interpGrp | lb | milestone | 
	pb)*)+, (divGen, (anchor | gap | figure | index | interp 
	| interpGrp | lb | milestone | pb)*)*, ((div, (div | divGen 
	| anchor | gap | figure | index | interp | interpGrp | lb 
	| milestone | pb)*) | (div0, (div0 | divGen | anchor | gap 
	| figure | index | interp | interpGrp | lb | milestone | 
	pb)*) | (div1, (div1 | divGen | anchor | gap | figure | 
	index | interp | interpGrp | lb | milestone | pb)*))?) | 
	((divGen, (anchor | gap | figure | index | interp | interpGrp 
	| lb | milestone | pb)*)*, ((div, (div | divGen | anchor 
	| gap | figure | index | interp | interpGrp | lb | milestone 
	| pb)*) | (div0, (div0 | divGen | anchor | gap | figure 
	| index | interp | interpGrp | lb | milestone | pb)*) | 
	(div1, (div1 | divGen | anchor | gap | figure | index | 
	interp | interpGrp | lb | milestone | pb)*)))), ((byline 
	| closer | dateline | epigraph | salute | signed | trailer), 
	(anchor | gap | figure | index | interp | interpGrp | lb 
	| milestone | pb)*)*) >
<!ATTLIST body 
	corresp IDREFS #IMPLIED
...
<!ELEMENT group 
	((argument | byline | dateline | docAuthor | docDate | epigraph 
	| head | opener | salute | signed | anchor | gap | figure 
	| index | interp | interpGrp | lb | milestone | pb)*, (text 
	| group), (text | group | anchor | gap | figure | index 
	| interp | interpGrp | lb | milestone | pb)*, ((byline | 
	closer | dateline | epigraph | salute | signed | trailer), 
	(anchor | gap | figure | index | interp | interpGrp | lb 
	| milestone | pb)*)*) >
...
<!ELEMENT div 
	...
	| divGen), (anchor | gap | figure | index | interp | interpGrp 
	| lb | milestone | pb)*)+ | (((eg | bibl | biblFull | ab 
	| l | lg | p | sp | cit | q | label | list | listBibl | 
	note | stage | table), (anchor | gap | figure | index | 
	interp | interpGrp | lb | milestone | pb)*)+, ((div | divGen), 
	(anchor | gap | figure | index | interp | interpGrp | lb 
	| milestone | pb)*)*)), ((byline | closer | dateline | epigraph 
	| salute | signed | trailer), (anchor | gap | figure | index 
	| interp | interpGrp | lb | milestone | pb)*)*) >
<!ATTLIST div 
	corresp IDREFS #IMPLIED
	next IDREF #IMPLIED
...
<!ELEMENT div0 
	((argument | byline | dateline | docAuthor | docDate | epigraph 
	| head | opener | salute | signed | anchor | gap | figure 
	| index | interp | interpGrp | lb | milestone | pb)*, (((div1 
	| divGen), (anchor | gap | figure | index | interp | interpGrp 
	| lb | milestone | pb)*)+ | (((eg | bibl | biblFull | ab 
	| l | lg | p | sp | cit | q | label | list | listBibl | 
	note | stage | table), (anchor | gap | figure | index | 
	interp | interpGrp | lb | milestone | pb)*)+, ((div1 | divGen), 
	(anchor | gap | figure | index | interp | interpGrp | lb 
	| milestone | pb)*)*)), ((byline | closer | dateline | epigraph 
	| salute | signed | trailer), (anchor | gap | figure | index 
	| interp | interpGrp | lb | milestone | pb)*)*) >
...
<!ELEMENT div1 
	((argument | byline | dateline | docAuthor | docDate | epigraph 
	| head | opener | salute | signed | anchor | gap | figure 
	| index | interp | interpGrp | lb | milestone | pb)*, (((div2 
	| divGen), (anchor | gap | figure | index | interp | interpGrp 
	| lb | milestone | pb)*)+ | (((eg | bibl | biblFull | ab 
	| l | lg | p | sp | cit | q | label | list | listBibl | 
	note | stage | table), (anchor | gap | figure | index | 
	interp | interpGrp | lb | milestone | pb)*)+, ((div2 | divGen), 
	(anchor | gap | figure | index | interp | interpGrp | lb 
	| milestone | pb)*)*)), ((byline | closer | dateline | epigraph 
	| salute | signed | trailer), (anchor | gap | figure | index 
	| interp | interpGrp | lb | milestone | pb)*)*) >
...
<!ELEMENT div2 
	((argument | byline | dateline | docAuthor | docDate | epigraph 
	| head | opener | salute | signed | anchor | gap | figure 
	| index | interp | interpGrp | lb | milestone | pb)*, (((div3 
	| divGen), (anchor | gap | figure | index | interp | interpGrp 
	| lb | milestone | pb)*)+ | (((eg | bibl | biblFull | ab 
	| l | lg | p | sp | cit | q | label | list | listBibl | 
	note | stage | table), (anchor | gap | figure | index | 
	interp | interpGrp | lb | milestone | pb)*)+, ((div3 | divGen), 
	(anchor | gap | figure | index | interp | interpGrp | lb 
	| milestone | pb)*)*)), ((byline | closer | dateline | epigraph 
	| salute | signed | trailer), (anchor | gap | figure | index 
	| interp | interpGrp | lb | milestone | pb)*)*) >
...
<!ELEMENT div3 
	((argument | byline | dateline | docAuthor | docDate | epigraph 
	| head | opener | salute | signed | anchor | gap | figure 
	| index | interp | interpGrp | lb | milestone | pb)*, (((div4 
	| divGen), (anchor | gap | figure | index | interp | interpGrp 
	| lb | milestone | pb)*)+ | (((eg | bibl | biblFull | ab 
	| l | lg | p | sp | cit | q | label | list | listBibl | 
	note | stage | table), (anchor | gap | figure | index | 
	interp | interpGrp | lb | milestone | pb)*)+, ((div4 | divGen), 
	(anchor | gap | figure | index | interp | interpGrp | lb 
	| milestone | pb)*)*)), ((byline | closer | dateline | epigraph 
	| salute | signed | trailer), (anchor | gap | figure | index 
	| interp | interpGrp | lb | milestone | pb)*)*) >
...
<!ELEMENT div4 
	((argument | byline | dateline | docAuthor | docDate | epigraph 
	| head | opener | salute | signed | anchor | gap | figure 
	| index | interp | interpGrp | lb | milestone | pb)*, (((div5 
	| divGen), (anchor | gap | figure | index | interp | interpGrp 
	| lb | milestone | pb)*)+ | (((eg | bibl | biblFull | ab 
	| l | lg | p | sp | cit | q | label | list | listBibl | 
	note | stage | table), (anchor | gap | figure | index | 
	interp | interpGrp | lb | milestone | pb)*)+, ((div5 | divGen), 
	(anchor | gap | figure | index | interp | interpGrp | lb 
	| milestone | pb)*)*)), ((byline | closer | dateline | epigraph 
	| salute | signed | trailer), (anchor | gap | figure | index 
	| interp | interpGrp | lb | milestone | pb)*)*) >
...
<!ELEMENT div5 
	((argument | byline | dateline | docAuthor | docDate | epigraph 
	| head | opener | salute | signed | anchor | gap | figure 
	| index | interp | interpGrp | lb | milestone | pb)*, (((div6 
	| divGen), (anchor | gap | figure | index | interp | interpGrp 
	| lb | milestone | pb)*)+ | (((eg | bibl | biblFull | ab 
	| l | lg | p | sp | cit | q | label | list | listBibl | 
	note | stage | table), (anchor | gap | figure | index | 
	interp | interpGrp | lb | milestone | pb)*)+, ((div6 | divGen), 
	(anchor | gap | figure | index | interp | interpGrp | lb 
	| milestone | pb)*)*)), ((byline | closer | dateline | epigraph 
	| salute | signed | trailer), (anchor | gap | figure | index 
	| interp | interpGrp | lb | milestone | pb)*)*) >
...
<!ELEMENT div6 
	((argument | byline | dateline | docAuthor | docDate | epigraph 
	| head | opener | salute | signed | anchor | gap | figure 
	| index | interp | interpGrp | lb | milestone | pb)*, (((div7 
	| divGen), (anchor | gap | figure | index | interp | interpGrp 
	| lb | milestone | pb)*)+ | (((eg | bibl | biblFull | ab 
	| l | lg | p | sp | cit | q | label | list | listBibl | 
	note | stage | table), (anchor | gap | figure | index | 
	interp | interpGrp | lb | milestone | pb)*)+, ((div7 | divGen), 
	(anchor | gap | figure | index | interp | interpGrp | lb 
	| milestone | pb)*)*)), ((byline | closer | dateline | epigraph 
	| salute | signed | trailer), (anchor | gap | figure | index 
	| interp | interpGrp | lb | milestone | pb)*)*) >
...
<!ELEMENT div7 
	...
	| list | listBibl | note | stage | table), (anchor | gap 
	| figure | index | interp | interpGrp | lb | milestone | 
	pb)*)+, ((byline | closer | dateline | epigraph | salute 
	| signed | trailer), (anchor | gap | figure | index | interp 
	| interpGrp | lb | milestone | pb)*)*) >
<!ATTLIST div7 
	corresp IDREFS #IMPLIED
	next IDREF #IMPLIED
...
<!ELEMENT byline 
	...
	| unclear | formula | emph | foreign | gloss | hi | mentioned 
	| soCalled | term | title | ptr | ref | xptr | xref | s 
	| seg | gi | docAuthor | anchor | gap | figure | index | 
	interp | interpGrp | lb | milestone | pb)* >
<!ATTLIST byline 
	corresp IDREFS #IMPLIED
	next IDREF #IMPLIED
...
<!ELEMENT dateline 
	(#PCDATA | date | time | name | address | anchor | gap | 
	figure | index | interp | interpGrp | lb | milestone | pb)* >
<!ATTLIST dateline 
	corresp IDREFS #IMPLIED
	next IDREF #IMPLIED
...
<!ELEMENT argument 
	((anchor | gap | figure | index | interp | interpGrp | lb 
	| milestone | pb)*, (head, (anchor | gap | figure | index 
	| interp | interpGrp | lb | milestone | pb)*)?, ((eg | bibl 
	| biblFull | ab | l | lg | p | sp | cit | q | label | list 
	| listBibl | note | stage | table), (anchor | gap | figure 
	| index | interp | interpGrp | lb | milestone | pb)*)+) >
<!ATTLIST argument 
	corresp IDREFS #IMPLIED
	next IDREF #IMPLIED
...
<!ELEMENT epigraph 
	((anchor | gap | figure | index | interp | interpGrp | lb 
	| milestone | pb)*, ((eg | bibl | biblFull | ab | l | lg 
	| p | sp | cit | q | label | list | listBibl | note | stage 
	| table), (anchor | gap | figure | index | interp | interpGrp 
	| lb | milestone | pb)*)*) >
<!ATTLIST epigraph 
	corresp IDREFS #IMPLIED
	next IDREF #IMPLIED
...
<!ELEMENT opener 
	...
	| unclear | formula | emph | foreign | gloss | hi | mentioned 
	| soCalled | term | title | ptr | ref | xptr | xref | s 
	| seg | gi | argument | byline | dateline | epigraph | salute 
	| signed | anchor | gap | figure | index | interp | interpGrp 
	| lb | milestone | pb)* >
<!ATTLIST opener 
	corresp IDREFS #IMPLIED
	next IDREF #IMPLIED
...
<!ELEMENT closer 
	(#PCDATA | signed | dateline | salute | ident | code | kw 
	| abbr | address | date | name | num | rs | time | add | 
	corr | del | orig | reg | sic | unclear | formula | emph 
	| foreign | gloss | hi | mentioned | soCalled | term | title 
	| ptr | ref | xptr | xref | s | seg | gi | anchor | gap 
	| figure | index | interp | interpGrp | lb | milestone | 
	pb)* >
<!ATTLIST closer 
	corresp IDREFS #IMPLIED
...
<!ELEMENT docTitle 
	((anchor | gap | figure | index | interp | interpGrp | lb 
	| milestone | pb)*, (titlePart, (anchor | gap | figure | 
	index | interp | interpGrp | lb | milestone | pb)*)+) >
<!ATTLIST docTitle 
	corresp IDREFS #IMPLIED
	next IDREF #IMPLIED
...
<!ELEMENT docImprint 
	...
	| unclear | formula | emph | foreign | gloss | hi | mentioned 
	| soCalled | term | title | ptr | ref | xptr | xref | s 
	| seg | gi | pubPlace | docDate | publisher | anchor | gap 
	| figure | index | interp | interpGrp | lb | milestone | 
	pb)* >
<!ATTLIST docImprint 
	corresp IDREFS #IMPLIED
...
<!ELEMENT back 
	((divGen | titlePage | anchor | gap | figure | index | interp 
	| interpGrp | lb | milestone | pb)*, (((argument | byline 
	| dateline | docAuthor | docDate | epigraph | head | opener 
	| salute | signed), (argument | byline | dateline | docAuthor 
	| docDate | epigraph | head | opener | salute | signed | 
	titlePage | anchor | gap | figure | index | interp | interpGrp 
	| lb | milestone | pb)*) | (div, (div | divGen | titlePage 
	| anchor | gap | figure | index | interp | interpGrp | lb 
	| milestone | pb)*) | (div1, (div1 | divGen | titlePage 
	| anchor | gap | figure | index | interp | interpGrp | lb 
	| milestone | pb)*))?, (trailer | closer)*) >
<!ATTLIST back 
	corresp IDREFS #IMPLIED
	next IDREF #IMPLIED
	prev IDREF #IMPLIED
...
<!ELEMENT table 
	((head | anchor | gap | figure | index | interp | interpGrp 
	| lb | milestone | pb)*, (row, (anchor | gap | figure | 
	index | interp | interpGrp | lb | milestone | pb)*)+) >
<!ATTLIST table 
	corresp IDREFS #IMPLIED
	next IDREF #IMPLIED
...
<!ELEMENT row 
	((cell | table), (anchor | gap | figure | index | interp 
	| interpGrp | lb | milestone | pb)*)+ >
<!ATTLIST row 
	corresp IDREFS #IMPLIED
	next IDREF #IMPLIED
...
<!ELEMENT figure 
	((anchor | gap | figure | index | interp | interpGrp | lb 
	| milestone | pb)*, (head, (anchor | gap | figure | index 
	| interp | interpGrp | lb | milestone | pb)*)?, (p, (anchor 
	| gap | figure | index | interp | interpGrp | lb | milestone 
	| pb)*)*, (figDesc, (anchor | gap | figure | index | interp 
	| interpGrp | lb | milestone | pb)*)?, (text, (anchor | 
	gap | figure | index | interp | interpGrp | lb | milestone 
	| pb)*)?) >
<!ATTLIST figure 
	corresp IDREFS #IMPLIED
